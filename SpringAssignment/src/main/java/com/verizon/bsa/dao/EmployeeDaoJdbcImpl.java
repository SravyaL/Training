...
public class EmployeeDaoJdbcImpl implements EmployeeDao {
	...
	public Employee addBook(Employee book) {
		int count = jdbcTemplate.update(IQueryMapper.INS_BOOK_QRY, book.getEid(), book.getName(), book.getBasic(),
				book.getHra(), book.getDept());
	...
	public Employee updateBook(Employee book) {
		int count = jdbcTemplate.update(IQueryMapper.UPDATE_BOOK_QRY,
				...
				book.getName(), book.getBasic(), book.getHra(), book.getDept(), book.getEid());
	...
	public Employee getBookById(int eid) {
		List<Employee> books = jdbcTemplate.query(IQueryMapper.GET_BOOK_QRY, new Object[] { eid },
	...
	public List<Employee> getAllBooks() {
		List<Employee> books = jdbcTemplate.query(IQueryMapper.GET_ALL_BOOK_QRY, new EmployeeRowMapper());
		return books;
	}
